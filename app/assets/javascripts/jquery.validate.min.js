    ...
    a.extend(a.fn, {
        ...
        prototype: {
            ...
            showLabel: function(b, c) {
                ...
                for (let a = 0; this.errorList[a]; a++) {
                    let $input = $(`input#${this.errorList[a]["element"].id}`);
                        oldLabel = $input.parents('span:first').children('label:first');
                    oldLabel.fadeIn('slow', function() {
                        oldLabel.remove();
                    });
                }
